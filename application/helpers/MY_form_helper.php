...
if ( ! function_exists('form_dropdown'))
{
    ...
    function form_dropdown($name = '', $options = array(), $selected = array(), $extra = '', $disabled = array(), $default = FALSE)
    {
        ...
        {
            /* Nelson Cabrera - Added functionality to add images to chosen dropdowns, by using the chosenimage plugin.*/
...
if ( ! function_exists('form_dropdown_icon'))
{
    /* CI modified form_dropdown function to support Disables */
    function form_dropdown_icon($name = '', $options = array(), $selected = array(), $extra = '', $disabled = array(), $default = FALSE)
    {
        if ( ! is_array($selected))
        {
            $selected = array($selected);
        ...
        foreach ($options as $key => $val)
        {
            ...
            foreach ($val as $optgroup_key => $optgroup_val)
            {
                ...
                if(is_array($val) && isset($optgroup_val['data']))
                {
                    ...
                    {
                        $data_options .= ($data_key != 'icon')? ' data-'.$data_key.'= "'.$data_value.'"' : ' data-img-src="'.$data_value.'"';
                    }
                }
...
if ( ! function_exists('form_dropdown_data'))
{
    ...
    if ( ! function_exists('checkbox_in_array'))
    {
        function checkbox_in_array($array, $value)
        {
