                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form class="user">
                                    <div class="form-group"><input type="email" class="form-control form-control-user" id="exampleInputEmail" placeholder="Usuario..."></div>
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary btn-user btn-block">Login</a>
                                </form>
                                <hr>
