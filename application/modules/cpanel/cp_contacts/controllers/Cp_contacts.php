...
//        $this->load->module('com_accounts/controllers/com_accounts');
    ...
    {
        $result = $this->cp_contacts_model->ignitedtables($this->columns);
    ...
    {
        $data                           = array();
        $data['row']                    = $this->cp_contacts_model->get($annulmentId);
    ...
    public function insert()
    {
        ...
        else
        {
            ...
            if($this->cp_contacts_model->save($data))
            {
    ...
    public function update($annulmentId)
    {
        ...
        else
        {
            ...
            if($this->cp_contacts_model->save($data, $annulmentId))
            {
                echo json_encode(array('result' => 1));
            }
        }
    ...
    {
        $result['result'] = ($this->cp_contacts_model->save( array('hidden' => 1), $annulmentId) == TRUE )? 1 : 0;
