<div class="modal-content">
    ...
    <div class="modal-body">
        <form id="form" action="<?php echo base_url('cp_services/insert');?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-8 solid-black">
                    <div class="row form-group">
                        ...
                        <div class="col-md-7"><input type="text" class="form-control" id="name_services" name="name_services" placeholder=""></div>
                    </div>
                    <div class="row form-group">
					...
					<div class="row form-group">
						...
						<div class="col-md-7"><input type="email" class="form-control" id="correo" name="correo" placeholder=""></div>
					</div>
					<div class="row form-group">
