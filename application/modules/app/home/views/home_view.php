...
<!--                    <a href="#" class="view-more">View sall</a>-->
					<input type="text" class="view-more" placeholder="Buscar....">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 col-sm-6">
                <div class="single-featured-properties">
                    <div class="properties-image">
                        <a href="#"><img src="<?php echo base_url();?>assets/img/properties/1.jpg" alt=""></a>
                    </div>
                    <div class="sale-tag">
                        <p>For Sale</p>
                    </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="single-featured-properties">
                    <div class="properties-image">
                        <a href="#"><img src="<?php echo base_url();?>assets/img/properties/2.jpg" alt=""></a>
                    </div>
                    <div class="sale-tag">
                        <p>For Sale</p>
                    </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="single-featured-properties">
                    <div class="properties-image">
                        <a href="#"><img src="<?php echo base_url();?>assets/img/properties/3.jpg" alt=""></a>
                    </div>
                    <div class="sale-tag">
                        <p>For Sale</p>
                    </div>
