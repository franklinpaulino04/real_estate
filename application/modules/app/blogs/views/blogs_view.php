		...
		<div class="row">
			<div class="col-md-4">
				<div class="card-box-b card-shadow news-box">
					<div class="img-box-b">
						<img src="<?php echo base_url()?>assets/img/post-1.jpg" alt="" class="img-b img-fluid">
					</div>
			...
			<div class="col-md-4">
				<div class="card-box-b card-shadow news-box">
					<div class="img-box-b">
						<img src="<?php echo base_url()?>assets/img/post-4.jpg" alt="" class="img-b img-fluid">
					</div>
					<div class="card-overlay">
						<div class="card-header-b">
							<div class="card-category-b">
			...
			<div class="col-md-4">
				<div class="card-box-b card-shadow news-box">
					<div class="img-box-b">
						<img src="<?php echo base_url()?>assets/img/post-6.jpg" alt="" class="img-b img-fluid">
					</div>
					<div class="card-overlay">
						<div class="card-header-b">
							<div class="card-category-b">
