...
var table = $('#list').DataTable({
	"ajax": url.baseUrl() + "cp_services/datatables",
	"language"    : url.baseUrl() + 'assets/sb_admin/js/demo/datatable_spanish.json',
	"columns": [
		{"data": 'serviceId',   "sClass": "dt-serviceId",   "width": "0",     "defaultContent": "<i class='na'>N/A</i>"},
		...
		{"data": 'phone',       "sClass": "dt-phone",       "width": "15%",   "defaultContent": "<i class='na'>N/A</i>"},
		{"data": 'mobile',      "sClass": "dt-mobile",      "width": "15%",   "defaultContent": "<i class='na'>N/A</i>"},
		{"data": 'correo',      "sClass": "dt-correo",      "width": "20%",   "defaultContent": "<i class='na'>N/A</i>"},
...
var image = function (data) {
	return (Object.keys(data.image).length === 0 || data.image === null)? data.name + ' <img src="' + url.baseUrl() + 'assets/sb_admin/img/images_empty.png" width="50px" height="50px">' : data.name + ' <img src="' + url.baseUrl() + 'assets/storage/files/services/'+data.image+'" width="50px" height="50px">';
};
